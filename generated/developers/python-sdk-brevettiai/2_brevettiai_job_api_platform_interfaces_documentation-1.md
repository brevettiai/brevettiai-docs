...
```
    ...
    <__main__.MyCustomObject object at 0x7f71ad47e750> {'custom_param': 5}
...
```
    ...
    /tmp/config-id-ae03ff72-b7a2-444d-8fe9-623f61dc4c71-3ppzpwxf/something_i_want_to_save_temporarily.txt
