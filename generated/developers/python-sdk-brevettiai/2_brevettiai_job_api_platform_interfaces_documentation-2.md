...
```
    ...
    2022-02-02 12:30:46.317840: W tensorflow/stream_executor/platform/default/dso_loader.cc:64] Could not load dynamic library 'libcuda.so.1'; dlerror: libcuda.so.1: cannot open shared object file: No such file or directory; LD_LIBRARY_PATH: /opt/hostedtoolcache/Python/3.7.12/x64/lib/python3.7/site-packages/cv2/../../lib64:/opt/hostedtoolcache/Python/3.7.12/x64/lib
    2022-02-02 12:30:46.317883: W tensorflow/stream_executor/cuda/cuda_driver.cc:269] failed call to cuInit: UNKNOWN ERROR (303)
    2022-02-02 12:30:46.317909: I tensorflow/stream_executor/cuda/cuda_diagnostics.cc:156] kernel driver does not appear to be running on this host (fv-az152-690): /proc/driver/nvidia/version does not exist
    2022-02-02 12:30:46.318243: I tensorflow/core/platform/cpu_feature_guard.cc:151] This TensorFlow binary is optimized with oneAPI Deep Neural Network Library (oneDNN) to use the following CPU instructions in performance-critical operations:  AVX2 AVX512F FMA
...
```
    ...
    (<brevettiai.data.tf_utils.NumpyStringIterator at 0x7f10bffd7650>,
     <brevettiai.data.tf_utils.NumpyStringIterator at 0x7f10bff3a210>)
...
```
    ...
    <matplotlib.colorbar.Colorbar at 0x7f10bcae0610>
...
```
    ...
    <matplotlib.image.AxesImage at 0x7f10bcc14dd0>
...
```
    ...
    <matplotlib.image.AxesImage at 0x7f10bc7d5d10>
