...
```
    ...
    2022-03-24 16:39:40.043255: W tensorflow/stream_executor/platform/default/dso_loader.cc:64] Could not load dynamic library 'libcudart.so.11.0'; dlerror: libcudart.so.11.0: cannot open shared object file: No such file or directory; LD_LIBRARY_PATH: /opt/hostedtoolcache/Python/3.7.12/x64/lib
    2022-03-24 16:39:40.043286: I tensorflow/stream_executor/cuda/cudart_stub.cc:29] Ignore above cudart dlerror if you do not have a GPU set up on your machine.
...
```
    ...
    2022-03-24 16:39:41.561789: W tensorflow/stream_executor/platform/default/dso_loader.cc:64] Could not load dynamic library 'libcuda.so.1'; dlerror: libcuda.so.1: cannot open shared object file: No such file or directory; LD_LIBRARY_PATH: /opt/hostedtoolcache/Python/3.7.12/x64/lib
    2022-03-24 16:39:41.561821: W tensorflow/stream_executor/cuda/cuda_driver.cc:269] failed call to cuInit: UNKNOWN ERROR (303)
    2022-03-24 16:39:41.561840: I tensorflow/stream_executor/cuda/cuda_diagnostics.cc:156] kernel driver does not appear to be running on this host (fv-az91-768): /proc/driver/nvidia/version does not exist
    2022-03-24 16:39:41.562029: I tensorflow/core/platform/cpu_feature_guard.cc:151] This TensorFlow binary is optimized with oneAPI Deep Neural Network Library (oneDNN) to use the following CPU instructions in performance-critical operations:  AVX2 AVX512F FMA
...
```
    ...
    Epoch 1/2
    1/1 [==============================] - 5s 5s/step - loss: 6.0288 - accuracy: 0.2500
    Epoch 2/2
    1/1 [==============================] - 1s 599ms/step - loss: 7.8838 - accuracy: 0.0000e+00


    2022-03-24 16:39:59.192494: W tensorflow/core/framework/cpu_allocator_impl.cc:82] Allocation of 154140672 exceeds 10% of free system memory.
    2022-03-24 16:39:59.219510: W tensorflow/core/framework/cpu_allocator_impl.cc:82] Allocation of 156905472 exceeds 10% of free system memory.
    ...
    Instructions for updating:
    Use fn_output_signature instead
    100%|██████████| 32/32 [00:00<00:00, 714.33it/s]
    ...
    <keras.engine.sequential.Sequential at 0x7f7f4a16be90>
